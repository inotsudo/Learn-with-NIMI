...
// TODO: Implement Featured Stories section (story card grid with cover, title, play badge).
export default function Stories() {
  return (
    <Section id="stories">
      <Container>
        <div className="flex items-center justify-center min-h-[180px] rounded-2xl border-2 border-dashed border-gray-200">
          <p className="font-nunito text-gray-400 text-sm">[ Stories section — coming soon ]</p>
        </div>
      </Container>
    </Section>
  );
