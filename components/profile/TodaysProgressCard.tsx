    ...
    <div className="bg-white border-2 border-purple-200 rounded-2xl shadow-md p-4">
      <div className="flex items-center gap-3 mb-3">
        <div className="relative w-14 h-14 shrink-0">
          <svg viewBox="0 0 56 56" className="w-full h-full -rotate-90">
            <circle cx="28" cy="28" r={RING_RADIUS} fill="none" stroke="#ede9fe" strokeWidth="6" />
            <circle
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="font-black text-purple-700 text-xs">{done}/8</span>
          </div>
        </div>
        <p className="font-black text-gray-800">{t("todaysProgressTitle")}</p>
      </div>
      ...
      <div className="space-y-1.5">
        {ACTIVITIES.map(activity => {
          ...
          return (
            <div key={activity.number} className="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50">
