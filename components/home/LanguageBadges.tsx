...
export default function LanguageBadges({ activeChild, earnedLanguages, onLanguageChanged }: LanguageBadgesProps) {
  ...
  return (
    <div className="bg-white border-2 border-green-100 rounded-2xl shadow-md p-4">
      <h3 className="font-black text-purple-700 text-[12px] uppercase mb-3 flex items-center gap-1.5 tracking-wide">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center gap-3">
          ...
          {LANG_BADGES.map(badge => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center bg-white border-[3px] ${earned ? badge.border : "border-gray-200"} rounded-[50%] shadow-md overflow-hidden hover:scale-105 transition-transform cursor-pointer ${badge.code === language ? "ring-2 ring-purple-300" : ""}`}
                ...
                <div className="pb-1 pt-0.5 text-center leading-none">
                  <p className={`text-[7px] font-black uppercase ${earned ? "text-gray-800" : "text-gray-400"}`}>{badge.line1}</p>
                  <p className={`text-[7px] font-black uppercase ${earned ? "text-gray-800" : "text-gray-400"}`}>{badge.line2}</p>
        ...
        {/* Description */}
        <div className="bg-blue-50 rounded-xl p-2.5 xl:flex-1 xl:min-w-0">
          <p className="text-[9.5px] font-bold text-gray-700 leading-relaxed">
            {t("languageBadgesDesc")}
          </p>
          <p className="text-[9px] text-gray-500 leading-relaxed mt-1">
            {t("languageBadgesHint")}
          </p>
          <p className="mt-1.5 text-[9px] font-black text-purple-600">
