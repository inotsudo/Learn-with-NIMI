...
export default function MyProfile({ childName, avatar, categoriesMastered }: Props) {
  return (
    <div className="bg-white border-2 border-purple-200 rounded-2xl shadow-md p-4 text-center flex flex-col h-full">
      <h3 className="font-black text-purple-700 text-[12px] uppercase mb-3 tracking-widest">MY PROFILE</h3>
      ...
      <div className="flex items-center justify-center gap-1 mt-1 mb-0.5">
        <p className="font-black text-purple-800 text-sm uppercase tracking-wide">{childName}</p>
        <Edit className="w-3.5 h-3.5 text-purple-400" />
      </div>
      <p className="text-[11px] font-bold text-yellow-600 mb-3">⭐ SUPER STAR ★</p>
      <div className="text-left mb-3">
        ...
        <p className="text-[10px] text-gray-400 text-right">{categoriesMastered}/8</p>
      </div>
