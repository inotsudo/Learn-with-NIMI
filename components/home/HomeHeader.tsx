    ...
    <header className="bg-white border-b border-ds-border shadow-ds-nav relative overflow-hidden">
          ...
          <motion.div className="flex-shrink-0"
            ...
            <div className="relative">
              <div className="w-20 h-20 lg:w-28 lg:h-28 xl:w-32 xl:h-32 rounded-full overflow-hidden border-4 border-blue-300 shadow-2xl ring-4 ring-blue-100">
                <img src={assets.pikoCircle} alt="PIKO" className="w-full h-full object-cover" />
              </div>
      ...
      <div className="sm:hidden flex items-center justify-between px-3 py-3 relative z-10">
        <div className="flex items-center gap-2">
          <div className="relative">
            <img src={assets.nimiCircle} alt="NIMI" className="w-11 h-11 rounded-full object-cover border-2 border-yellow-400 shadow-md" />
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <img src={assets.pikoCircle} alt="PIKO" className="w-9 h-9 rounded-full object-cover border-2 border-blue-300 shadow" />
