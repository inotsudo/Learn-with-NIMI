      ...
      <div className="relative z-10 py-4 px-5 text-center">
        ...
        <div className="flex items-end justify-between mt-3 px-1 sm:px-4">
          <div className="flex flex-col items-center gap-0.5">
            <img src={assets.nimiCircle} alt="NIMI" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-yellow-400 shadow-lg" />
          ...
          <div className="flex flex-col items-center gap-0.5">
            <img src={assets.pikoCircle} alt="PIKO" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-blue-400 shadow-lg" />
            <p className="text-gray-400 text-[7px]">{t("storyCertSigned")}</p>
