...
const assetRegistry: Record<string, ThemeAssets> = {
  ...
  ocean: {
    nimiLogo:          "/themes/ocean/nimi-logo.png",
    nimiLogoText:      "/themes/ocean/nimipiko-logo-text.png",
    nimiCircle:        "/themes/ocean/nimi-circle.png",
    pikoCircle:        "/themes/ocean/piko-circle.png",
    nimiAuth:          "/themes/ocean/nimipiko.png",
    nimiHappy:         "/themes/ocean/nimi-happy.png",
    nimiSad:           "/themes/ocean/nimi-sad.png",
    nimiLocked:        "/themes/ocean/nimi-locked.png",
    nimiCelebration:   "/themes/ocean/nimi-celebration.png",
    starMascot:        "/themes/ocean/star-mascot.svg",
    trophy:            "/themes/ocean/trophy.svg",
    badgeExplorer:     "/themes/ocean/badge-explorer.svg",
    badgeKindHeart:    "/themes/ocean/badge-kindheart.svg",
    badgeHero:         "/themes/ocean/badge-hero.svg",
    iconFlipflop:      "/assets/icon-flipflop.svg",
    iconPdf:           "/assets/icon-pdf.svg",
    iconColoring:      "/assets/icon-coloring.svg",
    iconMove:          "/assets/icon-move.svg",
    ...
    homeHero:          "/themes/ocean/hero.png",
    homeHeroMobile:    "/themes/ocean/hero-mobile.png",
    communityHeader:   "/themes/ocean/community-header.png",
    storyCurrentCover: "/current-story.png",
    storyContinue:     "/continue.png",
    storyComplete:     "/story-complete.png",
    heroImage:          "/themes/ocean/hero.png",
    backgroundArtwork:  "/themes/ocean/background.png",
    badgeArtwork:       "/themes/ocean/badge.png",
    celebrationAssets:  ["/themes/ocean/confetti.png"],
    illustrationFolder: "/themes/ocean/illustrations/",
    decorations: {
